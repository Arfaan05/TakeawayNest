...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addToCartButtons.forEach((button, index) => {
        ...
        if (svgElement) {
            svgElement.addEventListener('click', function(e) {
                ...
                const productCard = this.closest('.product-card') || this.closest('div');
    ...
    function handleCheckout() {
        ...
        // For now, we'll just show a notification and clear the cart
        showNotification(`Order placed successfully! We'll contact you on +91${phoneValue}`);
    ...
    // FIX 2: Fix for mobile - prevent cart from opening automatically on load
    // Initialize cart but with a short delay to ensure the page loads fully first
    setTimeout(function() {
        updateCart();
    }, 100);
